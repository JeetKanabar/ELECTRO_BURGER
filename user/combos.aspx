<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="combos.aspx.cs" Inherits="user_coffee" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <html xmlns="http://www.w3.org/1999/xhtml">
        <body>
            <div>
                <h1 style="margin-bottom:20px; margin-top:20px;" align="center">Combos</h1>
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#000000" BorderStyle="None" BorderWidth="1px" CellPadding="10" GridLines="Both"  RepeatDirection="Horizontal" RepeatColumns="3" style="margin-left:50px;margin-right:50px;" OnItemCommand="DataList1_ItemCommand">
