<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="burger.aspx.cs" Inherits="burger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <html xmlns="http://www.w3.org/1999/xhtml">
        <body>
            <div>
                <h1 style="margin-bottom:20px; margin-top:20px;" align="center">BURGER</h1>
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#000000" BorderStyle="None" BorderWidth="10px" CellPadding="10" GridLines="Both" HeaderStyle-BorderStyle="Solid"  RepeatDirection="Horizontal" RepeatColumns="3" style="margin-left:100px" OnItemCommand="DataList1_ItemCommand">
